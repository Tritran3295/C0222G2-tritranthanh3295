...
public class Book {
    ...
    public Book(int id, String name, String code, String author, String publishingCompany, int totalPage, String size, int amount, double price, LocalDate releaseDate, String img, boolean statusDelete, TypeBook typeBook, Set<BookBill> bookBill) {
        this.id = id;
        this.name = name;
        this.code = code;
        this.author = author;
